...
```
### 13. Instalacon de la base de datos
...
### 15. Comprobar conexion  de base de datos a instancia
telnet database-1.cbs4y06s6sd3.us-east-2.rds.amazonaws.com 3306


### 15.1 Error en la conexion
...
### 15.2 Vuelve a intentar la conexion
...
### 17. Generación de Certificado SSL Autofirmado
...
```
### 18. Configurar Nginx para usar SSL
